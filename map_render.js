...
// end include: preamble.js
  ...
  var _glfwGetMonitorPos = (monitor, x, y) => {
      HEAP32[((x)>>2)] = 0;checkInt32(0);
      HEAP32[((y)>>2)] = 0;checkInt32(0);
    };
  ...
  var _glfwGetMonitorWorkarea = (monitor, x, y, w, h) => {
      ...
      HEAP32[((w)>>2)] = screen.availWidth;checkInt32(screen.availWidth);
      HEAP32[((h)>>2)] = screen.availHeight;checkInt32(screen.availHeight);
    };

  
  var _glfwGetMonitors = (count) => {
      HEAP32[((count)>>2)] = 1;checkInt32(1);
      if (!GLFW.monitors) {
        GLFW.monitors = _malloc(4);
        HEAP32[((GLFW.monitors)>>2)] = 1;checkInt32(1);
      }
